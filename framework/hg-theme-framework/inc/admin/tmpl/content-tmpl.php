				...
				<div class="znfb-row">
						...
						<div class="zn-lead-text">
							...
							if( ! $isConnected ){ ?>
								<div class="zn-adminNotice zn-adminNotice-error">
									...
									<p>Please go back to step 2 (Theme Registration) and register Kallyas to gain full access to the Plugins.</p>
					...
					<?php if( $isConnected ){ ?>
						<div class="<?php echo esc_attr($section2_cols);?>">
							<a href="#" class="js-refresh-plugins zn_admin_button zn-refresh-theme-plugins-button" title="Click to refresh the plugins list" data-nonce="<?php echo wp_create_nonce('refresh_plugins_list');?>">Refresh List</a>
						</div>
					<?php } ?>
				</div>

				<?php include( ZNHGTFW()->getFwPath( '/inc/admin/inc/addons_manager/ui/tmpl-addons-list.php' ) ); ?>
			</div><!-- /.zn-about-tab -->
